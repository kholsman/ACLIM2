    ...
    for(d in c(weekly_flnm,survey_rep_flnm)){
      ...
      if(from_thredds){
        ...
        if(download_nc){
          ...
          tmpURL <- paste0(paste0(ACLIM_data_urlIN,"fileServer/",m,"/Level3/"),d,"_",m,".nc")
          message(paste0("downloading ",tmpURL))
          #download.file(tmpURL,destfile = tmppath, overwrite = overwriteIN)
          ...
          # access nc remotely
          tmpURL <- paste0(paste0(ACLIM_data_urlIN,"dodsC/",m,"/Level3/"),d,"_",m,".nc")
