...
makeACLIM2_BC_Indices_new <- function(
  ...
  if(!dir.exists(here("Data/out",CMIP_fdlr)))
    dir.create(here("Data/out",CMIP_fdlr))

  if(!dir.exists(here("Data/out",CMIP_fdlr,paste0("BC_",subtxt))))
   dir.create(here("Data/out",CMIP_fdlr,paste0("BC_",subtxt)))
  fl <- here("Data/out",CMIP_fdlr,paste0("BC_",subtxt))
