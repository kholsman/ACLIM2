...
The remainder of this tutorial was testing in RStudio. This may work in plain R, but is untested.  If you are using RStudio, open `ACLIM2.Rproj` in Rstudio. If using R, use `setwd()` to get to the main ACLIM2 directory. Then run:
