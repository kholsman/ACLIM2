...
```
![Decadal averages of bottom temperature from the two hindcast models.](Figs/mn_hindcast_mhw.jpg){ width=75% }
...
![Weekly indcices by sub-region](Figs/hind_weekly_bystrata.jpg){ width=65% }

![Weekly indcices by sub-region](Figs/hind_weekly_byreg.jpg){ width=65% }
...
![Large fall zooplankton integrated concentration](Figs/Hind_Fall_large_Zoop.jpg){ width=65% }
...
![September large zooplankton integrated concentration](Figs/Hind_Sept_large_Zoop.jpg){ width=65% }
...
![Aug 1 Bottom temperature from Level 2 dataset](Figs/Hind_sub_grid_mn_BT_Aug1.jpg){ width=65% }
