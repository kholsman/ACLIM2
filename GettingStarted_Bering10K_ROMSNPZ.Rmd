...
```{r explore_srvy1, eval=F, echo=T}
    
    # preview the l3 data for the hindcast:
    all_info1%>%filter(name =="B10K-K20_CORECFS")
...
![Decadal averages of bottom temperature from the two hindcast models.](Figs/mn_hindcast_BT.jpg)
