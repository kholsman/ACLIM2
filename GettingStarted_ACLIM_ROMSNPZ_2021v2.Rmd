...
![Multiple programs and projects have supported the production and sharing of the suite of Bering10K hindcasts and projections.](Figs/logos2.jpg){ width=90%}
...
The code within the ACLIM2 github repo is publicly available and canbe accessed at [**ACLIM Repo: github.com/kholsman/ACLIM2**](https://github.com/kholsman/ACLIM2 "ACLIM2 Repo"). The repo is maintain by [Kirstin Holsman](kirstin.holsman@noaa.gov) within input and contributions from the ACLIM PIs and collaborators. More information on the ACLIM project can be found on the [**project website**](https://www.fisheries.noaa.gov/alaska/ecosystems/alaska-climate-integrated-modeling-project) and in [Hollowed et al. 2020](https://www.frontiersin.org/articles/10.3389/fmars.2019.00775/full).
