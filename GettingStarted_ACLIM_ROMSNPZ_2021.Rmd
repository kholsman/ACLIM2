...
2) [**00_ACLIM_shared>02_DATA>Map_layers**](https://drive.google.com/drive/u/0/folders/0Bx7wdZllbuF9eDJndkhCS2EwQUk "00_ACLIM_shared>02_DATA>Map_layers"). This folder contains base maps for the code below including `shp_files` and `geo_tif` folders.

![Your local `ACLIM2/Data` directory should look something like this when you are done downloading the data.](Figs/data_dir.jpg){ width=65% }
