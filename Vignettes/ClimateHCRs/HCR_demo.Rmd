...
plotdat5 <- rbind(data.frame(B2B0=B2B0,
                      ...
                      alpha = 0.05, B2B0_lim = 0.2, B2B0_target=0.4)),
                      alpha = 0.05, B2B0_lim = 0.2, B2B0_target=0.4, 
                      HCR = "HCR5a: no sensitivity" , HCRscen="HCR 5"),
                   data.frame(B2B0=B2B0, 
                      F_adj = unlist(lapply(B2B0, HCR2,
                      gamma=.1, 
                      alpha = 0.05, B2B0_lim = 0.2, B2B0_target=0.4)),
                      alpha = 0.05, B2B0_lim = 0.2, B2B0_target=0.4, 
                      HCR = "HCR5b: low sensitivity", HCRscen="HCR 5"),
                   data.frame(B2B0=B2B0, 
                            F_adj = unlist(lapply(B2B0, HCR2,
                      gamma=.3, 
                      alpha = 0.05, B2B0_lim = 0.2, B2B0_target=0.4)),
                      alpha = 0.05, B2B0_lim = 0.2, B2B0_target=0.4, 
                      HCR = "HCR5c: medium sensitivity", HCRscen="HCR 5"),
                 data.frame(B2B0=B2B0, 
                            F_adj = unlist(lapply(B2B0, HCR2,
                      gamma=.7, 
                      alpha = 0.05, B2B0_lim = 0.2, B2B0_target=0.4)),
                      alpha = 0.05, B2B0_lim = 0.2, B2B0_target=0.4, 
                       HCR = "HCR5d: high sensitivity", HCRscen="HCR 5"))%>%
  mutate(HCR = factor(HCR,levels=HCR_levels),
         HCRscen = factor(HCRscen,levels=HCRscen_levels))
...
plotdat6 <- rbind(data.frame(B2B0=B2B0,
                      ...
                      alpha = 0.2, B2B0_lim = 0.2, B2B0_target=0.4, 
                      HCR = "HCR6a: no MHW, no sensitivity" , HCRscen="HCR 6"),
                   data.frame(B2B0=B2B0, 
                            F_adj = unlist(lapply(B2B0, HCR2,
                      gamma=.1, 
                      alpha = 0.2, B2B0_lim = 0.2, B2B0_target=0.4)),
                      alpha = 0.2, B2B0_lim = 0.2, B2B0_target=0.4, 
                      HCR = "HCR6b: small MHW, low sensitivity", HCRscen="HCR 6"),
                 ...
                 data.frame(B2B0=B2B0, 
                      ...
                      alpha = 0.4, B2B0_lim = 0.2, B2B0_target=0.4, 
                       HCR = "HCR6c: large MHW, high sensitivity", HCRscen="HCR 6"))%>%
  mutate(HCR = factor(HCR,levels=HCR_levels),
         HCRscen = factor(HCRscen,levels=HCRscen_levels))


p <- ggplot(rbind(plotdat1,plotdat2,plotdat3,plotdat4,plotdat5,plotdat6))+
  geom_vline(aes(xintercept=B2B0_target),linetype="dashed",size=1.1, color="gray")+
  geom_line(aes(x=B2B0,y=F_adj,color=HCR),size=1)+
  facet_grid(HCRscen~.)+
   coord_cartesian(ylim = c(0,1.3))+   theme_minimal()+ 
