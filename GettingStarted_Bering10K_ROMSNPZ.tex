...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{Figs/hind_weekly_bystrata.jpg}
\caption{Weekly indcices by sub-region}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{Figs/hind_weekly_byreg.jpg}
\caption{Weekly indcices by sub-region}
\end{figure}
...
\includegraphics[width=1\textwidth,height=\textheight]{Figs/Hind_Fall_large_Zoop.jpg}
...
\includegraphics[width=1\textwidth,height=\textheight]{Figs/Hind_Sept_large_Zoop.jpg}
...
\NormalTok{    p9_hind}
    ...
    \ControlFlowTok{if}\NormalTok{(update.figs)  }\KeywordTok{ggsave}\NormalTok{(}\DataTypeTok{file=}\KeywordTok{file.path}\NormalTok{(main,}\StringTok{"Figs/Hind_sub_grid_mn_BT_Aug1.jpg"}\NormalTok{),}\DataTypeTok{width=}\DecValTok{8}\NormalTok{,}\DataTypeTok{height=}\DecValTok{4}\NormalTok{)}
