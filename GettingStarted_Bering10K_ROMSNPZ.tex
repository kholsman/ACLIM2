...
\NormalTok{    all_info1}\OperatorTok{%>%}\KeywordTok{filter}\NormalTok{(name }\OperatorTok{==}\StringTok{"B10K-K20_CORECFS"}\NormalTok{)}
...
\NormalTok{    vl        <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}
                  ...
                  \StringTok{"Cop_integrated"}\NormalTok{,  }\CommentTok{# Small Cop}
                  \StringTok{"EupS_integrated"}\NormalTok{) }\CommentTok{# Euphausiids}
    \CommentTok{#var_use   <- "temp_bottom5m"}
...
\NormalTok{    lab_t      <-}\StringTok{ }\CommentTok{# ms[2]%>%stringr::str_remove("([^-])")}
\StringTok{    }
\StringTok{    }\NormalTok{p_hind_}\DecValTok{3}\NormalTok{         <-}\StringTok{ }\KeywordTok{plot_stations_basemap}\NormalTok{(}\DataTypeTok{sfIN =}\NormalTok{ mn_var_sf,}
...
\begin{figure}
\centering
\includegraphics{Figs/mn_hindcast_BT.jpg}
