...
is maintained by \textbf{\url{kirstin.holsman@noaa.gov}}, Alaska
Fisheries Science Center, NOAA Fisheries, Seattle WA. Multiple programs
and projects have supported the production and sharing of the suite of
Bering10K hindcasts and projections.\emph{Last updated: Mar 08, 2021}}
\end{figure}
...
accessed at \href{https://github.com/kholsman/ACLIM2}{\textbf{ACLIM
Repo: github.com/kholsman/ACLIM2}}. The repo is maintain by
\href{kirstin.holsman@noaa.gov}{Kirstin Holsman} within input and
contributions from the ACLIM PIs and collaborators. More information on
the ACLIM project can be found on the
\href{https://www.fisheries.noaa.gov/alaska/ecosystems/alaska-climate-integrated-modeling-project}{\textbf{project
website}} and in
\href{https://www.frontiersin.org/articles/10.3389/fmars.2019.00775/full}{Hollowed
et al.~2020}.

\hypertarget{aclim-suite-of-downscaled-projections-and-carbon-scenarios}{%
\subsection{1.1. ACLIM suite of downscaled projections and carbon
scenarios}\label{aclim-suite-of-downscaled-projections-and-carbon-scenarios}}
